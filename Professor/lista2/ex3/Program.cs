...
namespace Visual
{
	class Program
	{
		...
		static string getNomeCompleto(int numero)
		{
			...
			{
				throw new Exception("numero deve ser maior ou igual a zero e menor que um bilhao");
			}
		...
		static void Main(string[] args)
		{
			while(true)
			{
				try
				{
					Console.WriteLine("\nInsira um numero inteiro entre 0 e 999,999,999 (ou um valor invalido para sair):");
